<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        //$senha_2 = password_verify($senha, $senha);

        $sql = "SELECT * FROM usuarios WHERE nomeUsuario = '$nome' AND emailUsuario = '$email' AND senhaUsuario = '$senha'";
        ...
        if(mysqli_num_rows($result) == 0 || mysqli_num_rows($result) > 1 )
        {
            ...
            echo "
                <script> window.alert('Verifique as credenciais') </script>
            ";
        ...
        } else 
        {
            ...
            $_SESSION['nBilhete'] = $usuario['nBilheteUsuario'];
            ...
            echo "
                <script> window.alert('Login feito com sucesso') </script>
            ";

            if($nome == 'admin1' || $nome == 'admin2' ) {
            ...
            <div class="contact-content" id="contact-area">
                <div class="contact-area">
                    ...
                    <form action="" method="post">
                        ...
                        <fieldset style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px; border: none;">
                            <label for=""> <input type="checkbox" name="lembrar" id=""> Remind-me </label>
                            <a href=""> I forgot my password</a>
                        </fieldset>
                        
                        <input type="submit" value=" Sign In " class="send-message-button" name="submit">
                    </form>
                    <a href="login.php"> Don't you have an account? </a>
                </div>
